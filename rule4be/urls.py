...
urlpatterns = [
     ...
     path('archived-aols/', page_views.load_archived_aols_page, name='load_archived_aols_page'),
     path('today/<int:pk>', page_views.load_today_snapshot_page,
          name='load_today_snapshot_page'),
     path('archived-snapshots/<int:aol_id>', page_views.load_archived_aol_snapshots,
          name='load_archived_aol_snapshots'),
